...
enum Constants {
    ...
    //static let defaultBaseUrl = URL(string: "hfghdfgh")!
    //static let unsplashGetTokenURLString = "имтмт авпр "
    //static let defaultBaseUrl = URL(string: "http://api.unsplash.com")!
    //static let unsplashGetTokenURLString = "http://unsplash.com/oauth/token"
}
